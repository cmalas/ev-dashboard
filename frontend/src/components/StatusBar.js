...
export default function StatusBar({ status, lastRefresh, onRefresh, pollerPaused, onTogglePoller, pollerToggling }) {
  ...
  return (
    <div className="status-bar">
      ...
      <div className={`status-dot ${isStale || pollerPaused ? 'stale' : 'live'}`} />
